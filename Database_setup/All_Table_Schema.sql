...
CREATE TABLE "Air_Quality" (
    ...
    "TractFIPS" INTEGER   NOT NULL,
    "CountyFIPS" INTEGER   NOT NULL,
    "Place_TractID" VARCHAR(20)   NOT NULL,
    "PM2.5_Exceptional" INTEGER   NOT NULL,
    "PM2.5_ExceedCount" INTEGER   NOT NULL,
    "PM2.5_Max" INTEGER   NOT NULL,
    "Ozone_Exceptional" INTEGER   NOT NULL,
    "Ozone_ExceedCount" INTEGER   NOT NULL,
    "Ozone_Max" FLOAT   NOT NULL,
